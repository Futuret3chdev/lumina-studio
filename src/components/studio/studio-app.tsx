  ...
  return (
    <div className="relative h-dvh overflow-hidden bg-bg text-fg">
      <div
        ...
        style={sheet === "inspector" ? { bottom: "42dvh" } : undefined}
      >
        <Viewport />
      </div>
      ...
      {sheet === "inspector" && (
        <div className="absolute inset-x-0 bottom-0 z-30 flex h-[42dvh] flex-col rounded-t-xl bg-surface shadow-[var(--shadow-border)] lg:hidden">
